...
from workflows.research_assistant.graph import invoke_graph

load_dotenv()

st.title("Research Assistant")
st.markdown("#### Tu Asistente Inteligente para investigar")

# st write magic
"""

Un asistente inteligente para ayudarte a investigar.
...
if "messages" not in st.session_state:
    ...
    st.session_state["messages"] = [AIMessage(content="Sobre que tema queres investigar?")]
